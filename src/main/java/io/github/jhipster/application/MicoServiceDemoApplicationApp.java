...
public class MicoServiceDemoApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(MicoServiceDemoApplicationApp.class);

    private final Environment env;

    public MicoServiceDemoApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes MicoServiceDemoApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MicoServiceDemoApplicationApp.class);
